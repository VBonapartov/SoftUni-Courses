namespace BookShop.Books
{
    ...
    using BookShop.Books.Infrastructure;
    using BookShop.Books.Infrastructure.Extensions;
    using BookShop.Books.Services;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services
                .AddWebService<BooksDbContext>(this.Configuration)
